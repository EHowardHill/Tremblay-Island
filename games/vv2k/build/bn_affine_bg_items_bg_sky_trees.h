...
//	+ 65 tiles (t reduced) not compressed
//	+ affine map, not compressed, 32x32 
//	Total size: 32 + 4160 + 1024 = 5216
//
//	Time-stamp: 2021-12-02, 23:17:23
...
#define bg_sky_trees_bn_graphicsTilesLen 4160
extern const bn::tile bg_sky_trees_bn_graphicsTiles[bn::max(1040 / 8, 1)];
...
namespace bn::affine_bg_items
{
    constexpr inline affine_bg_item bg_sky_trees(
            affine_bg_tiles_item(span<const tile>(bg_sky_trees_bn_graphicsTiles, 130), compression_type::NONE), 
