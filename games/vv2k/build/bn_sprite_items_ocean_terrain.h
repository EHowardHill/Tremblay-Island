...
//======================================================================
//
//	ocean_terrain_bn_graphics, 32x1696@4, 
//	+ palette 16 entries, not compressed
//	+ 848 tiles not compressed
//	Total size: 32 + 27136 = 27168
//
//	Time-stamp: 2021-12-09, 23:29:25
...
#define ocean_terrain_bn_graphicsTilesLen 27136
extern const bn::tile ocean_terrain_bn_graphicsTiles[bn::max(6784 / 8, 1)];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item ocean_terrain(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(ocean_terrain_bn_graphicsTiles, 848), bpp_mode::BPP_4, compression_type::NONE, 53), 
