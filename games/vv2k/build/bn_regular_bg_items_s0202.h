...
//
//	Time-stamp: 2021-09-11, 02:33:54
...
#define s0202_bn_graphicsTilesLen 19232
extern const bn::tile s0202_bn_graphicsTiles[bn::max(4808 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0202(
            regular_bg_tiles_item(span<const tile>(s0202_bn_graphicsTiles, 601), bpp_mode::BPP_4, compression_type::NONE), 
