...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(33), string_view("pc_boot")),
        make_pair(sound_item(34), string_view("pc_whir")),
        make_pair(sound_item(35), string_view("pop")),
        make_pair(sound_item(36), string_view("shortclip")),
        make_pair(sound_item(37), string_view("squeak")),
        make_pair(sound_item(38), string_view("start")),
        make_pair(sound_item(47), string_view("ui_sfx01")),
        make_pair(sound_item(48), string_view("ui_sfx02")),
        make_pair(sound_item(49), string_view("ui_sfx03")),
        make_pair(sound_item(99), string_view("z08_rain")),
    };
