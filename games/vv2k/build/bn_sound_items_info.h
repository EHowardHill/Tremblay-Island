...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(3), string_view("shortclip")),
        make_pair(sound_item(4), string_view("ui_sfx01")),
        make_pair(sound_item(5), string_view("ui_sfx02")),
        make_pair(sound_item(6), string_view("ui_sfx03")),
    };
