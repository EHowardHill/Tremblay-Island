...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(13), string_view("door")),
        make_pair(sound_item(14), string_view("fireblast")),
        make_pair(sound_item(15), string_view("firecrackle")),
        make_pair(sound_item(16), string_view("firehit")),
        make_pair(sound_item(19), string_view("heymaple")),
        make_pair(sound_item(25), string_view("pop")),
        make_pair(sound_item(26), string_view("shortclip")),
        make_pair(sound_item(27), string_view("squeak")),
