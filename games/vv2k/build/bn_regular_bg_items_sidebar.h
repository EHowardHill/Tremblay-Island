...
//
//	Time-stamp: 2021-10-16, 23:49:21
...
#define sidebar_bn_graphicsTilesLen 17440
extern const bn::tile sidebar_bn_graphicsTiles[bn::max(4360 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item sidebar(
            regular_bg_tiles_item(span<const tile>(sidebar_bn_graphicsTiles, 545), bpp_mode::BPP_4, compression_type::NONE), 
