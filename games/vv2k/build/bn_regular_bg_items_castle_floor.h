...
//
//	Time-stamp: 2021-09-02, 17:10:51
...
#define castle_floor_bn_graphicsTilesLen 32672
extern const bn::tile castle_floor_bn_graphicsTiles[bn::max(8168 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item castle_floor(
            regular_bg_tiles_item(span<const tile>(castle_floor_bn_graphicsTiles, 1021), bpp_mode::BPP_4, compression_type::NONE), 
