...
//
//	Time-stamp: 2021-08-26, 22:29:15
...
#define castle_floor_bn_graphicsTilesLen 20064
extern const bn::tile castle_floor_bn_graphicsTiles[bn::max(5016 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item castle_floor(
            regular_bg_tiles_item(span<const tile>(castle_floor_bn_graphicsTiles, 627), bpp_mode::BPP_4, compression_type::NONE), 
