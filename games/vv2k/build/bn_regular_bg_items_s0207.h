...
//
//	Time-stamp: 2021-09-14, 07:21:16
...
#define s0207_bn_graphicsTilesLen 11360
extern const bn::tile s0207_bn_graphicsTiles[bn::max(2840 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0207(
            regular_bg_tiles_item(span<const tile>(s0207_bn_graphicsTiles, 355), bpp_mode::BPP_4, compression_type::NONE), 
