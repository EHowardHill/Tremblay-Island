...
//	+ 355 tiles (t|f|p reduced) not compressed
//	+ regular map (flat), not compressed, 32x32 
//	Total size: 32 + 11360 + 2048 = 13440
//
//	Time-stamp: 2021-09-14, 07:19:28
...
#define s0206_bn_graphicsTilesLen 11360
extern const bn::tile s0206_bn_graphicsTiles[bn::max(2840 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0206(
            regular_bg_tiles_item(span<const tile>(s0206_bn_graphicsTiles, 355), bpp_mode::BPP_4, compression_type::NONE), 
