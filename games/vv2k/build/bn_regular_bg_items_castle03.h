...
#define castle03_bn_graphicsTilesLen 17312
extern const bn::tile castle03_bn_graphicsTiles[bn::max(4328 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item castle03(
            regular_bg_tiles_item(span<const tile>(castle03_bn_graphicsTiles, 541), bpp_mode::BPP_4, compression_type::NONE), 
