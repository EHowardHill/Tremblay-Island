...
//
//	Time-stamp: 2021-08-14, 01:23:06
...
#define s0104_bn_graphicsTilesLen 18880
extern const bn::tile s0104_bn_graphicsTiles[bn::max(4720 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0104(
            regular_bg_tiles_item(span<const tile>(s0104_bn_graphicsTiles, 590), bpp_mode::BPP_4, compression_type::NONE), 
