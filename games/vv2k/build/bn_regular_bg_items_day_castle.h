...
//
//	Time-stamp: 2021-09-10, 03:26:17
...
#define day_castle_bn_graphicsTilesLen 17376
extern const bn::tile day_castle_bn_graphicsTiles[bn::max(4344 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item day_castle(
            regular_bg_tiles_item(span<const tile>(day_castle_bn_graphicsTiles, 543), bpp_mode::BPP_4, compression_type::NONE), 
