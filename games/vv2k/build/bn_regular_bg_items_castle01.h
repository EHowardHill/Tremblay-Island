...
#define castle01_bn_graphicsTilesLen 17376
extern const bn::tile castle01_bn_graphicsTiles[bn::max(4344 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item castle01(
            regular_bg_tiles_item(span<const tile>(castle01_bn_graphicsTiles, 543), bpp_mode::BPP_4, compression_type::NONE), 
