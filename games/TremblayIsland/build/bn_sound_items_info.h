...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(55), string_view("motorboat")),
        make_pair(sound_item(61), string_view("pc_boot")),
        make_pair(sound_item(62), string_view("pc_whir")),
        make_pair(sound_item(63), string_view("pop")),
        make_pair(sound_item(64), string_view("rufus_01")),
        make_pair(sound_item(65), string_view("rufus_02")),
        make_pair(sound_item(66), string_view("scout_hey_01")),
        make_pair(sound_item(67), string_view("scout_nice_01")),
        make_pair(sound_item(68), string_view("shortclip")),
        make_pair(sound_item(69), string_view("squeak")),
        make_pair(sound_item(70), string_view("start")),
        make_pair(sound_item(79), string_view("ui_sfx01")),
        make_pair(sound_item(80), string_view("ui_sfx02")),
        make_pair(sound_item(81), string_view("ui_sfx03")),
        make_pair(sound_item(90), string_view("vee_alright_01")),
        make_pair(sound_item(91), string_view("vee_hey_01")),
        make_pair(sound_item(137), string_view("z08_rain")),
    };
