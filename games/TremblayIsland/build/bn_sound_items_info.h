...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(28), string_view("ding")),
        make_pair(sound_item(29), string_view("door")),
        ...
        make_pair(sound_item(40), string_view("maple_alright_01")),
        make_pair(sound_item(41), string_view("maple_alright_02")),
        make_pair(sound_item(42), string_view("maple_alright_03")),
        make_pair(sound_item(43), string_view("maple_alright_04")),
        make_pair(sound_item(44), string_view("maple_hey_01")),
        make_pair(sound_item(45), string_view("maple_ugh_01")),
        make_pair(sound_item(46), string_view("maple_ugh_02")),
        make_pair(sound_item(47), string_view("motorboat")),
        ...
        make_pair(sound_item(59), string_view("shortclip")),
        ...
        make_pair(sound_item(126), string_view("z08_rain")),
    };
