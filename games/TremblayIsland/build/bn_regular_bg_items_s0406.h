...
#define s0406_bn_graphicsTilesLen 20032
extern const bn::tile s0406_bn_graphicsTiles[bn::max(5008 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0406(
            regular_bg_tiles_item(span<const tile>(s0406_bn_graphicsTiles, 626), bpp_mode::BPP_4, compression_type::NONE), 
