...
//
//	Time-stamp: 2021-12-12, 23:10:38
...
#define bg_dock_bn_graphicsTilesLen 17344
extern const bn::tile bg_dock_bn_graphicsTiles[bn::max(4336 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item bg_dock(
            regular_bg_tiles_item(span<const tile>(bg_dock_bn_graphicsTiles, 542), bpp_mode::BPP_4, compression_type::NONE), 
