...
#define s0403_bn_graphicsTilesLen 20128
extern const bn::tile s0403_bn_graphicsTiles[bn::max(5032 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0403(
            regular_bg_tiles_item(span<const tile>(s0403_bn_graphicsTiles, 629), bpp_mode::BPP_4, compression_type::NONE), 
