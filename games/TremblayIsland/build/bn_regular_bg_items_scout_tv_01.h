...
#define scout_tv_01_bn_graphicsTilesLen 17792
extern const bn::tile scout_tv_01_bn_graphicsTiles[bn::max(4448 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item scout_tv_01(
            regular_bg_tiles_item(span<const tile>(scout_tv_01_bn_graphicsTiles, 556), bpp_mode::BPP_4, compression_type::NONE), 
