...
#define s0405_bn_graphicsTilesLen 18720
extern const bn::tile s0405_bn_graphicsTiles[bn::max(4680 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0405(
            regular_bg_tiles_item(span<const tile>(s0405_bn_graphicsTiles, 585), bpp_mode::BPP_4, compression_type::NONE), 
