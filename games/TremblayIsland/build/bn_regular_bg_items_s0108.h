...
#define s0108_bn_graphicsTilesLen 20160
extern const bn::tile s0108_bn_graphicsTiles[bn::max(5040 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0108(
            regular_bg_tiles_item(span<const tile>(s0108_bn_graphicsTiles, 630), bpp_mode::BPP_4, compression_type::NONE), 
