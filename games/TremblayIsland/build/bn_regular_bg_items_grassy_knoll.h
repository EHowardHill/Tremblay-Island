...
//	Total size: 32 + 32320 + 2048 = 34400
//
//	Time-stamp: 2022-02-07, 23:26:46
...
#define grassy_knoll_bn_graphicsTilesLen 32320
extern const bn::tile grassy_knoll_bn_graphicsTiles[bn::max(8080 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item grassy_knoll(
            regular_bg_tiles_item(span<const tile>(grassy_knoll_bn_graphicsTiles, 1010), bpp_mode::BPP_4, compression_type::NONE), 
