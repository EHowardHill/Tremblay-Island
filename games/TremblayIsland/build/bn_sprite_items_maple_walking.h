...
//======================================================================
//
//	maple_walking_bn_graphics, 32x512@4, 
//	+ palette 16 entries, not compressed
//	+ 256 tiles not compressed
//	Total size: 32 + 8192 = 8224
//
//	Time-stamp: 2022-02-20, 02:43:18
...
#define maple_walking_bn_graphicsTilesLen 8192
extern const bn::tile maple_walking_bn_graphicsTiles[bn::max(2048 / 8, 1)];
...
namespace bn::sprite_items
{
    constexpr inline sprite_item maple_walking(sprite_shape_size(sprite_shape::SQUARE, sprite_size::BIG), 
            sprite_tiles_item(span<const tile>(maple_walking_bn_graphicsTiles, 256), bpp_mode::BPP_4, compression_type::NONE, 16), 
