...
#define titlebackground_bn_graphicsTilesLen 17248
extern const bn::tile titlebackground_bn_graphicsTiles[bn::max(4312 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item titlebackground(
            regular_bg_tiles_item(span<const tile>(titlebackground_bn_graphicsTiles, 539), bpp_mode::BPP_4, compression_type::NONE), 
