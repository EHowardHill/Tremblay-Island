...
//	Total size: 32 + 16832 + 2048 = 18912
//
...
#define titlebackground_bn_graphicsTilesLen 16832
extern const bn::tile titlebackground_bn_graphicsTiles[bn::max(4208 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item titlebackground(
            regular_bg_tiles_item(span<const tile>(titlebackground_bn_graphicsTiles, 526), bpp_mode::BPP_4, compression_type::NONE), 
