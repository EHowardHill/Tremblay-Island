...
#define ocean_bn_graphicsTilesLen 18912
extern const bn::tile ocean_bn_graphicsTiles[bn::max(4728 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item ocean(
            regular_bg_tiles_item(span<const tile>(ocean_bn_graphicsTiles, 591), bpp_mode::BPP_4, compression_type::NONE), 
