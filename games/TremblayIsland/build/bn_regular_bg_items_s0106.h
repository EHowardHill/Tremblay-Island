...
#define s0106_bn_graphicsTilesLen 20064
extern const bn::tile s0106_bn_graphicsTiles[bn::max(5016 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0106(
            regular_bg_tiles_item(span<const tile>(s0106_bn_graphicsTiles, 627), bpp_mode::BPP_4, compression_type::NONE), 
