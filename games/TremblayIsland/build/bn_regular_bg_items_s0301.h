...
#define s0301_bn_graphicsTilesLen 12384
extern const bn::tile s0301_bn_graphicsTiles[bn::max(3096 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0301(
            regular_bg_tiles_item(span<const tile>(s0301_bn_graphicsTiles, 387), bpp_mode::BPP_4, compression_type::NONE), 
