...
#define s0302_bn_graphicsTilesLen 13472
extern const bn::tile s0302_bn_graphicsTiles[bn::max(3368 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0302(
            regular_bg_tiles_item(span<const tile>(s0302_bn_graphicsTiles, 421), bpp_mode::BPP_4, compression_type::NONE), 
