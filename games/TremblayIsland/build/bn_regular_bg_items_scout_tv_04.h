...
#define scout_tv_04_bn_graphicsTilesLen 16064
extern const bn::tile scout_tv_04_bn_graphicsTiles[bn::max(4016 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item scout_tv_04(
            regular_bg_tiles_item(span<const tile>(scout_tv_04_bn_graphicsTiles, 502), bpp_mode::BPP_4, compression_type::NONE), 
