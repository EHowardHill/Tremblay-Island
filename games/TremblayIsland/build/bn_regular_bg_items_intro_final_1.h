...
#define intro_final_1_bn_graphicsTilesLen 20160
extern const bn::tile intro_final_1_bn_graphicsTiles[bn::max(5040 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item intro_final_1(
            regular_bg_tiles_item(span<const tile>(intro_final_1_bn_graphicsTiles, 630), bpp_mode::BPP_4, compression_type::NONE), 
