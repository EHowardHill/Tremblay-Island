...
#define s0103_bn_graphicsTilesLen 19936
extern const bn::tile s0103_bn_graphicsTiles[bn::max(4984 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0103(
            regular_bg_tiles_item(span<const tile>(s0103_bn_graphicsTiles, 623), bpp_mode::BPP_4, compression_type::NONE), 
