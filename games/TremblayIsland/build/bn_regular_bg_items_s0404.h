...
#define s0404_bn_graphicsTilesLen 20192
extern const bn::tile s0404_bn_graphicsTiles[bn::max(5048 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0404(
            regular_bg_tiles_item(span<const tile>(s0404_bn_graphicsTiles, 631), bpp_mode::BPP_4, compression_type::NONE), 
