...
#define file_select_bg_bn_graphicsTilesLen 2496
extern const bn::tile file_select_bg_bn_graphicsTiles[bn::max(624 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item file_select_bg(
            regular_bg_tiles_item(span<const tile>(file_select_bg_bn_graphicsTiles, 78), bpp_mode::BPP_4, compression_type::NONE), 
