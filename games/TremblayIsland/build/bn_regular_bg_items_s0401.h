...
//	Total size: 32 + 14336 + 2048 = 16416
//
...
#define s0401_bn_graphicsTilesLen 14336
extern const bn::tile s0401_bn_graphicsTiles[bn::max(3584 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item s0401(
            regular_bg_tiles_item(span<const tile>(s0401_bn_graphicsTiles, 448), bpp_mode::BPP_4, compression_type::NONE), 
