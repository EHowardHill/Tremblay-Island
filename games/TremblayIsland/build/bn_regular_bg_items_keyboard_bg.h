...
#define keyboard_bg_bn_graphicsTilesLen 7392
extern const bn::tile keyboard_bg_bn_graphicsTiles[bn::max(1848 / 8, 1)];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item keyboard_bg(
            regular_bg_tiles_item(span<const tile>(keyboard_bg_bn_graphicsTiles, 231), bpp_mode::BPP_4, compression_type::NONE), 
